...
- [🔥 Issue Points](#🔥-issue-points)
  ...
  - [실시간 통신을 사용해 어떻게 사용자 경험을 향상시킬 수 있을까?](#실시간-통신을-사용해-어떻게-사용자-경험을-향상시킬-수-있을까)
    - [Socket.IO와 WebSocket 중 어떤 것을 사용해야 하지?](#1-socketio와-websocket-중-어떤-것을-사용해야-하지)
    - [Socket.IO 최적화의 중요성](#2-socketio-최적화의-중요성)
    - [이프로젝트 에서 Socket.IO를 어떻게 최적화를 적용하지?](#3-이프로젝트-에서-socketio를-어떻게-최적화를-적용하지)
- [🗓 Schedule](#-schedule)
...
### 1) Socket.IO와 WebSocket 중 어떤 것을 사용해야 하지?
...
### 3) 이프로젝트 에서 Socket.IO를 어떻게 최적화를 적용하지?
